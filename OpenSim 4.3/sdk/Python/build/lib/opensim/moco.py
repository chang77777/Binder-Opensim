...
class MocoOrientationTrackingGoal(MocoGoal):
    ...
    def setRotationReference(self, ref: "OpenSim::TimeSeriesTable_< OpenSim::Rotation > const &") -> "void":
        r"""
...
def analyzeMocoTrajectory(model: "Model", statesTable: "TimeSeriesTable", controlsTable: "TimeSeriesTable", outputPaths: "StdVectorString") -> "OpenSim::TimeSeriesTable_< double >":
    r"""
    Calculate the requested outputs using the model in the problem and the
...
def analyzeMocoTrajectoryVec3(model: "Model", statesTable: "TimeSeriesTable", controlsTable: "TimeSeriesTable", outputPaths: "StdVectorString") -> "OpenSim::TimeSeriesTable_< SimTK::Vec< 3,double,1 > >":
    r"""
    Calculate the requested outputs using the model in the problem and the
    provided states and controls tables
    The controls table is used to set the model's controls vector.
...
def analyzeMocoTrajectorySpatialVec(model: "Model", statesTable: "TimeSeriesTable", controlsTable: "TimeSeriesTable", outputPaths: "StdVectorString") -> "OpenSim::TimeSeriesTable_< SimTK::Vec< 2,SimTK::Vec3,1 > >":
    r"""
    Calculate the requested outputs using the model in the problem and the
    provided states and controls tables
    The controls table is used to set the model's controls vector.
